Title: Online Subscription Agreement | Microsoft Azure

URL Source: https://azure.microsoft.com/en-us/support/legal/subscription-agreement
...
**(i)**For academic offers, the requirements for educational institutions (including administrative offices or boards of education, public libraries, or public museums)listed in the[Microsoft Licensing Resources and Documents](https://go.microsoft.com/fwlink/?linkid=2243428).

**(ii)**For government offers, the requirements listed in the[Microsoft Licensing Resources and Documents](https://go.microsoft.com/fwlink/?linkid=2243428).

**(iii)**For nonprofit offers, the requirements listed in the[Microsoft Licensing Resources and Documents](https://go.microsoft.com/fwlink/?linkid=2243428).
...
"Online Services Terms" means the terms that apply to your use of the Products available in the[Microsoft Licensing use term documents](https://go.microsoft.com/fwlink/?linkid=2224700). The Online Services Terms include terms governing your use of Products that are in addition to the terms in this agreement.
...
"Portal" means the Online Services' respective web sites that can be found in the[Azure Portal](https://go.microsoft.com/fwlink/?linkid=2240552)or at an alternate website we identify.

"Product" means any Online Service (including any Software).

"SLA" means the commitments we make regarding delivery and/or performance of an Online Service, as published in the[Microsoft Service Level Agreements (SLA)](https://go.microsoft.com/fwlink/?linkid=2240922)or at an alternate site that we identify.
